...
const includes = [
  'Created',
  '✅',
  'Follow this link: https://ARuanLY.com/features/in-context-editing',
...
const excludes = [
  ...
  'api/*',
  'https://ARuanLY.com/features/in-context-editing',
  'http://localhost',
  'other:example',
  'some@example.com',
  'user.updated_successfully',
  'ARuanLY.service.plan',
  'ARuanLY.service.elastic_search',
  'ROLE_USER',
  'adminIndex',
  'admin_index',
